...
WITH desired_sectors(name, description) AS (
  VALUES
    ...
    ('REBOLO PENDULAR', 'Setor de rebolo pendular'),
    ...
    ('ACABAMENTO', 'Setor de acabamento de pecas'),
    ...
    ('MOLDAGEM COLDBOX', 'Setor de moldagem coldbox'),
    ...
    ('MANUTENÇÃO', 'Setor de manutencao'),
    ('USINAGEM', 'Setor de usinagem e processamento mecanico'),
    ('MARCENARIA', 'Setor de marcenaria'),
    ('DT', 'Setor DT'),
    ('CQD', 'Setor de controle de qualidade dimensional'),
    (U&'QUALIDADE LABORAT\00D3RIO', 'Setor de qualidade laboratorial'),
    (U&'AMBULAT\00D3RIO', 'Setor de ambulatorio'),
    ('COMPRAS', 'Setor de compras'),
    ('FACILITES', 'Setor de facilities'),
    (U&'SEGURAN\00C7A', 'Setor de seguranca'),
    ('COMERCIAL', 'Setor comercial'),
    ('RH', 'Setor de recursos humanos'),
    ('PCP', 'Setor de planejamento e controle da producao'),
    ('MONTAGEM', 'Setor de montagem de componentes'),
    ('FECHAMENTO', 'Setor de fechamento'),
    ('VAZAMENTO', 'Setor de vazamento'),
    ('FORNO', 'Setor de forno'),
    ('MODELARIA', 'Setor de modelaria'),
    ('MOLDAGEM COLDBOX', 'Setor de moldagem coldbox')
)
